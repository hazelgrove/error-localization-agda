...
module unicity where
  ...
  ↬⇒-τ-unicity (ISVar ∋x) (ISVar ∋x′) = ∋x≡ ∋x ∋x′
  ...
  ...                                                                  | refl = proj₂ (≡▸-→→≡ refl τ▸ τ′▸)
  ↬⇒-τ-unicity (ISAp1 {τ₁ = τ₁} {τ₂ = τ₂} e₁↬⇒ě₁ τ▸ e₂↬⇐ě₂) (ISAp2 e₁↬⇒ě₁′ τ!▸ e₂↬⇐ě₂′) with ↬⇒-τ-unicity e₁↬⇒ě₁ e₁↬⇒ě₁′
  ...                                                                  | refl = ⊥-elim (τ!▸ ⟨ τ₁ , ⟨ τ₂ , τ▸ ⟩ ⟩)
  ↬⇒-τ-unicity (ISAp2 e₁↬⇒ě₁ τ!▸ e₂↬⇐ě₂) (ISAp1 {τ₁ = τ₁} {τ₂ = τ₂} e₁↬⇒ě₁′ τ▸ e₂↬⇐ě₂′) with ↬⇒-τ-unicity e₁↬⇒ě₁ e₁↬⇒ě₁′
  ...                                                                  | refl = ⊥-elim (τ!▸ ⟨ τ₁ , ⟨ τ₂ , τ▸ ⟩ ⟩)
  ...
  ↬⇒-τ-unicity (ISIf e₁↬⇐ě₁ e₂↬⇒ě₂ e₃↬⇒ě₃ τ₁⊔τ₂) (ISInconsistentBranches e₁↬⇐ě₁′ e₂↬⇒ě₂′ e₃↬⇒ě₃′ τ₁~̸τ₂) with ↬⇒-τ-unicity e₂↬⇒ě₂ e₂↬⇒ě₂′ | ↬⇒-τ-unicity e₃↬⇒ě₃ e₃↬⇒ě₃′
  ...                                                                                     | refl                        | refl = ⊥-elim (τ₁~̸τ₂ (⊔→~ τ₁⊔τ₂))
  ↬⇒-τ-unicity (ISInconsistentBranches e₁↬⇐ě₁ e₂↬⇒ě₂ e₃↬⇒ě₃ τ₁~̸τ₂) (ISIf e₁↬⇐ě₁′ e₂↬⇒ě₂′ e₃↬⇒ě₃′ τ₁⊔τ₂) with ↬⇒-τ-unicity e₂↬⇒ě₂ e₂↬⇒ě₂′ | ↬⇒-τ-unicity e₃↬⇒ě₃ e₃↬⇒ě₃′
  ...                                                                                     | refl                        | refl = ⊥-elim (τ₁~̸τ₂ (⊔→~ τ₁⊔τ₂))
