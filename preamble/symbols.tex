...
\newcommand{\TNum}{\ensuremath{\textsf{Num}}}
...
\newcommand{\AIMName}{\textsf{ActionList}}
...
\newcommand{\movements}[1]{\ensuremath{#1 ~\textsf{movements}}}

% movement
\newcommand{\AMove}[1]{\ensuremath{\textsf{move $#1$}}}
\newcommand{\AMChild}[3]{\ensuremath{\AAction{#1}{#2}{\AMove{\textsf{child $#3$}}}}}
\newcommand{\AMParent}[2]{\ensuremath{\AAction{#1}{#2}{\AMove{\textsf{parent}}}}}
...
% deletion
\newcommand{\ATDel}[1]{\ensuremath{\ADel{\ZTCursor{#1}}{\ZTCursor{\TUnknown}}}}

% construction
\newcommand{\ATConArrow}[1]{\ensuremath{\ACon{\ZTCursor{#1}}{(\ZTArrowR{#1}{\ZTCursor{\TUnknown}})}{\textsf{arrow}}}}
\newcommand{\ATConNum}{\ensuremath{\ACon{\ZTCursor{\TUnknown}}{\ZTCursor{\TNum}}{\textsf{num}}}}
\newcommand{\ATConBool}{\ensuremath{\ACon{\ZTCursor{\TUnknown}}{\ZTCursor{\TBool}}{\textsf{bool}}}}
...
% movement
\newcommand{\AEMAction}[3]{\ensuremath{\AEAction{#1}{#2}{\textsf{move $#3$}}}}
...
% deletion
\newcommand{\AEDel}[1]{\ensuremath{\ADel{\ZCursor{#1}}{\ZCursor{\EEHole}}}}

% construction
\newcommand{\AEConVar}[1]{\ensuremath{\ACon{\ZCursor{\EEHole}}{\ZCursor{#1}}{\textsf{var $#1$}}}}
\newcommand{\AEConLam}[1]{\ensuremath{\ACon{\ZCursor{\EEHole}}{\ZLamT{#1}{\ZTCursor{\TUnknown}}{\EEHole}}{\textsf{lam}}}}
\newcommand{\AEConAp}[1]{\ensuremath{\ACon{\ZCursor{#1}}{\ZApR{#1}{\ZCursor{\EEHole}}}{\textsf{ap}}}}
\newcommand{\AEConNum}[1]{\ensuremath{\ACon{\ZCursor{\EEHole}}{\ZCursor{#1}}{\textsf{lit $#1$}}}}
\newcommand{\AEConPlus}[1]{\ensuremath{\ACon{\ZCursor{#1}}{\ZPlusR{#1}{\ZCursor{\EEHole}}}{\textsf{plus}}}}
\newcommand{\AEConTrue}{\ensuremath{\ACon{\ZCursor{\EEHole}}{\ZCursor{\ETrue}}{\textsf{lit $\ETrue$}}}}
\newcommand{\AEConFalse}{\ensuremath{\ACon{\ZCursor{\EEHole}}{\ZCursor{\EFalse}}{\textsf{lit $\EFalse$}}}}
\newcommand{\AEConIf}{\ensuremath{\ACon{\ZCursor{\EEHole}}{\ZIfC{\ZCursor{\EEHole}}{\EEHole}{\EEHole}}{\textsf{lit $\EFalse$}}}}
