...
% movement
\newcommand{\AMChild}[3]{\ensuremath{#1 \xrightarrow{\textsf{move child $#3$}} #2}}
\newcommand{\AMParent}[2]{\ensuremath{#1 \xrightarrow{\textsf{move parent}} #2}}
...
% deletion
\newcommand{\AMDel}[2]{\ensuremath{#1 \xrightarrow{\textsf{del}} #2}}
\newcommand{\ATMDel}[2]{\ensuremath{\AMDel{\ZCursor{#1}}{\ZCursor{#2}}}}
