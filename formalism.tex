...
\subsection{Syntax}
\[\begin{array}{rrcl}
  \TMName  & \TMV  \in \TMSet  & \Coloneqq & \TUnknown \mid \TInt \mid \TBool \mid \TArrow{\TMV}{\TMV} \\
  \EMName  & \EMV  \in \EMSet  & \Coloneqq & \EEHole \mid x \mid \ELam{x}{\TMV}{\EMV} \mid \EAp{\EMV}{\EMV} \\
           &                 & \mid         & \EIntMV \mid \EPlus{\EMV}{\EMV} \\
           &                 & \mid         & \ETrue \mid \EFalse \mid \EIf{\EMV}{\EMV}{\EMV} \\
  \ECMName & \ECMV \in \ECMSet & \Coloneqq & \ECEHole \mid x \mid \ECLam{x}{\TMV}{\ECMV} \mid \ECAp{\ECMV}{\ECMV} \\
...
\subsection{Image}
$\judgbox{\image{\EMV}}$ is the injection of $\EMV$ into marked expressions:
%
