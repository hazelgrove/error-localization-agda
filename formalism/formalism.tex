...
\begin{mathpar}
  ...
  \judgment{
    ...
    \ctxSynFixedInto{\extendCtx{\ctx}{x}{\ZTMV_1'}}{\ECMV}{\ECMV'}{\TMV_2'}
  }{
    \ASEAction{\ctx}{\ZLamT{x}{\ZTMV_1}{\ECMV}}{\TArrow{\cursorErase{\ZTMV_1}}{\TMV_2}}{\ZLamT{x}{\ZTMV_1'}{\ECMV'}}{\TArrow{\cursorErase{\ZTMV_1'}}{\TMV_2'}}{\AMV}
  }{ASEZipLamT2}
  ...
  \judgment{
    ...
    \ASEAction{\ctx}{\ZApL{\ZMV}{\ECMV}}{\TMV_1}{\ZApL{\ECMarkedInconType{\ZMV'}}{\ECMV}}{\TUnknown}{\AMV}
  }{ASEApL2}
  ...
  \judgment{
    ...
    \ASEAction{\ctx}{\ZApL{\ECMarkedInconType{\ZMV}}{\ECMV}}{\TUnknown}{\ZApL{\ZMV'}{\ECMV}}{\TMV_4}{\AMV}
  }{ASEApL3}
  ...
  \judgment{
    ...
    \ASEAction{\ctx}{\ZApL{\ECMarkedInconType{\ZMV}}{\ECMV}}{\TUnknown}{\ZApL{\ECMarkedInconType{\ZMV'}}{\ECMV}}{\TMV_4}{\AMV}
  }{ASEApL4}
  ...
  \judgment{
    ...
    \ASEAction{\ctx}{\ZLetL{x}{\ZMV}{\ECMV}}{\TMV_2}{\ZLetL{x}{\ZMV'}{\EMV'}}{\TMV_2'}{\AMV}
  }{ASELetL1}
  ...
  \judgment{
    ...
    \ASEAction{\ctx}{\ZMV}{\TMV_1}{\ZMV'}{\TMV_1'}{\AMV} \\\\
    \notEqual{\TMV_1}{\TMV_1'} \\
    \ctxSynFixedInto{\extendCtx{\ctx}{x}{\TMV_1'}}{\EMV_2}{\EMV_2'}{\TMV_2'}
  }{
    \ASEAction{\ctx}{\ZLetL{x}{\ZMV}{\ECMV}}{\TMV_2}{\ZLetL{x}{\ZMV'}{\EMV'}}{\TMV_2'}{\AMV}
  }{ASELetL2}
