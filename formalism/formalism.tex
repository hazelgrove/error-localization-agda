...
\[\begin{array}{rrcl}
  ...
  \ECMName & \ECMV & \Coloneqq & x \mid \ECLam{x}{\TMV}{\ECMV} \mid \ECAp{\ECMV}{\ECMV} \mid \ECLet{x}{\ECMV}{\ECMV}
           ...
           &       & \mid         & \ECUnbound{x} \mid \ECInconType{\ECMV} \mid \ECInconBr{\ECMV}{\ECMV}{\ECMV}
                     \mid           \ECNonMatchedArrow{\ECMV} % \mid \ECApNonMatchedAlt{\ECMV}{\ECMV}
                     \mid           \ECNonMatchedPair{\ECMV}
\end{array}\]
...
\judgbox{\ensuremath{\matchedPair{\TMV}{\TMV_1}{\TMV_2}}} $\TMV$ has matched binary product type $\TProd{\TMV_1}{\TMV_2}$
%
\begin{mathpar}
  \judgment{ }{
  ...
  \judgment{ }{
    \matchedPair{\TProd{\TMV_1}{\TMV_2}}{\TMV_1}{\TMV_2}
  }{TMPProd}
\end{mathpar} \\
...
\begin{mathpar}
  ...
  \judgment{
    ...
    \ctxSynFixedInto{\ctx}{\EAp{\EMV_1}{\EMV_2}}{\ECApNonMatchedArrow{\ECMV_1}{\ECMV_2}}{\TUnknown}
  }{MKSAp2}
  ...
  \judgment{
    ...
    \ctxSynFixedInto{\ctx}{\EProjL{\EMV}}{\ECProjLNonMatchedPair{\ECMV}}{\TMV_1}
  }{MKSProjL2}
  ...
  \judgment{
    ...
    \ctxSynFixedInto{\ctx}{\EProjR{\EMV}}{\ECProjRNonMatchedPair{\ECMV}}{\TMV_2}
  }{MKSProjR2}
\end{mathpar} \\
...
\begin{mathpar}
  ...
  \judgment{
    ...
    \ctxSynType{\ctx}{\ECAp{\ECNonMatchedArrow{\ECMV}}{\ECMV}}{\TUnknown}
  }{MSAp2}
  ...
  \judgment{
    ...
    \ctxSynType{\ctx}{\ECProjLNonMatchedPair{\ECMV}}{\TUnknown}
  }{MSProjL2}
  ...
  \judgment{
    ...
    \ctxSynType{\ctx}{\ECProjRNonMatchedPair{\ECMV}}{\TUnknown}
  }{MSProjR2}
\end{mathpar} \\
  ...
  \begin{enumerate}
    ...
    \item \begin{enumerate}
        \item If there does not exist $\TMV$ such that $\ctxSynType{\ctx}{\EMV}{\TMV}$, then for all
          $\ECMV$ and $\TMV'$ such that $\ctxSynFixedInto{\ctx}{\EMV}{\ECMV}{\TMV'}$, it is not the
          case that $\markless{\ECMV}$.
        \item If there does not exist $\TMV$ such that $\ctxAnaType{\ctx}{\EMV}{\TMV}$, then for all
          $\ECMV$ and $\TMV'$ such that $\ctxAnaFixedInto{\ctx}{\EMV}{\ECMV}{\TMV'}$, it is not the
          case that $\markless{\ECMV}$.
      \end{enumerate}
  \end{enumerate}
\end{theorem}
...
\begin{mathpar}
  \judgment{
    \ctxSynType{\ctx}{\cursorErase{\ZMV_1}}{\TMV_1} \\
...
\begin{mathpar}
  ...
  \judgment{
    \ctxSynType{\ctx}{\ECMV_1}{\TMV_1} \\
    \ctxSynType{\extendCtx{\ctx}{x}{\TMV_1}}{\cursorErase{\ZMV_2}}{\TMV_2} \\\\
