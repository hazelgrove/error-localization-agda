...
\begin{mathpar}
  ...
  \judgment{
    ...
    \ctxSynTypeM{\ctx}{\ECAp{\ECNonMatchedArrow{\ECMV}}{\ECMV}}{\TUnknown}
  }{MSAp2}
  ...
  \judgment{
    ...
    \ctxSynTypeM{\ctx}{\ECProjLNonMatchedPair{\ECMV}}{\TUnknown}
  }{MSProjL2}
  ...
  \judgment{
    ...
    \ctxSynTypeM{\ctx}{\ECProjRNonMatchedPair{\ECMV}}{\TUnknown}
  }{MSProjR2}
\end{mathpar} \\
...
\begin{mathpar}
  ...
  \judgment{
    ...
    \ctxAnaTypeM{\ctx}{\ECInconType{\ECLam{x}{\TMV}{\ECMV}}}{\TMV_3}
  }{MALam2}
  ...
  \judgment{
    ...
    \ctxAnaTypeM{\ctx}{\ECInconType{\ECPair{\ECMV_1}{\ECMV_2}}}{\TMV}
  }{MAPair2}
