...
\[\begin{array}{rrcl}
  ...
  \ZMName  & \ZMV  & \Coloneqq & \ZCursor{\ECMV} \mid \ZLamT{x}{\ZTMV}{\ECMV} \mid \ZLamE{x}{\TMV}{\ZMV} \mid \ZApL{\ZMV}{\ECMV} \mid \ZApR{\ECMV}{\ZMV} \\
           ...
           &       & \mid         & \ZMarked{\ZMV}{\MRMV}
\end{array}\]

\subsection{Action Model}

\subsubsection{Type Actions}
Type actions are the same as in untyped Hazelnut.
...
\begin{mathpar}
  ...
  \judgment{
    ...
    \ASEConApL{\ctx}{\ECMV}{\TMV}{\ECMarkedInconType{\ECMV}}{\TUnknown}
  }{ASEConApL2}
...
\begin{mathpar}
  ...
  \judgment{
    ...
    \ASEConPlusL{\ctx}{\ECMV}{\TMV}{\ECMarkedInconType{\ECMV}}
  }{ASEConPlusL2} \\
  ...
  \judgment{
    ...
    \ASEConPlusR{\ctx}{\ECMV}{\TMV}{\ECMarkedInconType{\ECMV}}
  }{ASEConPlusR2}
\end{mathpar}
...
\begin{mathpar}
  ...
  \judgment{
    ...
    \ASEConIfC{\ctx}{\ECMV}{\TMV}{\ECMarkedInconType{\ECMV}}
  }{ASEConIfC2}
...
\begin{mathpar}
  ...
  % TODO: Zipper cases for error cases
\end{mathpar}
