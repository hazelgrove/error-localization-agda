...
\begin{mathpar}
  \judgment{ }{
    \ctxSynType{\ctx}{\EEHole}{\TUnknown}
  }{USHole}
...
\begin{mathpar}
  ...
  \judgment{
    ...
    \ctxSynType{\ctx}{\ECApNonMatchedAlt{\ECMV}{\ECMV}}{\TUnknown}
  }{MSAp2'}
\end{mathpar}
...
\begin{mathpar}
  ...
  \judgment{
    ...
    \ASEConUnboundVar{\extendCtx{\ctx}}{x}
  }{ASEConUnbound}
\end{mathpar}

\begin{mathpar}
  \judgment{
    \ctxSynFixedInto{\extendCtx{\ctx}{x}{\TUnknown}}{\ECMV}{\ECMV'}{\TMV'}
  }{
...
\begin{mathpar}
  ...
  \judgment{
    ...
    \ctxSynFixedInto{\extendCtx{\ctx}{x}{\ZTMV_1'}}{\erase{\ECMV}}{\ECMV'}{\TMV_2'}
  }{
    \ASEAction{\ctx}{\ZLamT{x}{\ZTMV_1}{\ECMV}}{\TArrow{\cursorErase{\ZTMV_1}}{\TMV_2}}{\ZLamT{x}{\ZTMV_1'}{\ECMV'}}{\TArrow{\cursorErase{\ZTMV_1'}}{\TMV_2'}}{\AMV}
  }{ASEZipLamT2}

  \judgment{
    \ctxSynType{\extendCtx{\ctx}{x}{\TMV_1}}{\cursorErase{\ZMV}}{\TMV_2} \\
...
\begin{mathpar}
  \judgment{
    \ctxSynType{\ctx}{\cursorErase{\ZMV}}{\TMV_2} \\
    \ASEAction{\ctx}{\ZMV}{\TMV_2}{\ZMV'}{\TMV_3}{\AMV} \\\\
    \matchedArrow{\TMV_3}{\TMV_4}{\TMV_5} \\
    \ctxAnaType{\ctx}{\ECMV}{\TMV_4}
  }{
    \ASEAction{\ctx}{\ZApL{\ZMV}{\ECMV}}{\TMV_1}{\ZApL{\ZMV'}{\ECMV}}{\TMV_5}{\AMV}
  }{ASEZipApL1}

  \judgment{
    \ctxSynType{\ctx}{\cursorErase{\ZMV}}{\TMV_2} \\
    \ASEAction{\ctx}{\ZMV}{\TMV_2}{\ZMV'}{\TMV_3}{\AMV} \\\\
    \notMatchedArrow{\TMV_3}{\TMV_4}{\TMV_5}
  }{
    \ASEAction{\ctx}{\ZApL{\ZMV}{\ECMV}}{\TMV_1}{\ZApL{\ECInconType{\ZMV'}}{\ECMV}}{\TUnknown}{\AMV}
  }{ASEZipApL2}

  \judgment{
    \ctxSynType{\ctx}{\cursorErase{\ZMV}}{\TMV_1} \\
    \ASEAction{\ctx}{\ZMV}{\TMV_1}{\ZMV'}{\TMV_2}{\AMV} \\\\
    \matchedArrow{\TMV_2}{\TMV_3}{\TMV_4} \\
    \ctxAnaType{\ctx}{\ECMV}{\TMV_4}
  }{
    \ASEAction{\ctx}{\ZApL{\ECInconType{\ZMV}}{\ECMV}}{\TUnknown}{\ZApL{\ZMV'}{\ECMV}}{\TMV_4}{\AMV}
  }{ASEZipApL3}

  \judgment{
    \ctxSynType{\ctx}{\cursorErase{\ZMV}}{\TMV_1} \\
    \ASEAction{\ctx}{\ZMV}{\TMV_1}{\ZMV'}{\TMV_2}{\AMV} \\\\
    \notMatchedArrow{\TMV_2}{\TMV_3}{\TMV_4}
  }{
    \ASEAction{\ctx}{\ZApL{\ECInconType{\ZMV}}{\ECMV}}{\TUnknown}{\ZApL{\ECInconType{\ZMV'}}{\ECMV}}{\TMV_4}{\AMV}
  }{ASEZipApL4}

  \judgment{
    \ctxSynType{\ctx}{\ECMV}{\TMV_2} \\
    \matchedArrow{\TMV_2}{\TMV_3}{\TMV_4} \\
    \AAEAction{\ctx}{\ZMV}{\ZMV'}{\TMV_3}{\AMV}
  }{
    \ASEAction{\ctx}{\ZApR{\ECMV}{\ZMV}}{\TMV_1}{\ZApR{\ECMV}{\ZMV'}}{\TMV_4}{\AMV}
  }{ASEZipApR}
\end{mathpar}
...
\begin{mathpar}
  \judgment{
    ...
    \ASEAction{\ctx}{\ZLetL{x}{\ZMV}{\ECMV}}{\TMV_2}{\ZLetL{x}{\ZMV'}{\ECMV'}}{\TMV_2'}{\AMV}
  }{ASEZipLetL1}
  ...
  \judgment{
    \ctxSynType{\ctx}{\ECMV}{\TMV_1} \\
    \ctxSynType{\extendCtx{\ctx}{x}{\TMV_1}}{\ECMV}{\TMV_2} \\\\
    \ASEAction{\extendCtx{\ctx}{x}{\TMV_1}}{\ZMV}{\TMV_2}{\ZMV'}{\TMV_2'}{\AMV}
  }{
    \ASEAction{\ctx}{\ZLetR{x}{\ECMV}{\ZMV}}{\TMV_2}{\ZLetR{x}{\ECMV}{\ZMV'}}{\TMV_2'}{\AMV}
  }{ASEZipLetR}
\end{mathpar}
...
\begin{mathpar}
  \judgment{
    \matchedArrow{\TMV}{\TMV_1}{\TMV_2} \\
    \ctxAnaFixedInto{\extendCtx{\ctx}{x}{\TUnknown}}{\ECMV}{\ECMV'}{\TMV_2}
  }{
    \AACon{\ctx}{\ZCursor{\ECMV}}{\ZLamT{x}{\ZTCursor{\TUnknown}}{\ECMV'}}{\TMV}{\SLam{x}}
  }{AAEConLam1}
...
\begin{mathpar}
  ...
  \judgment{
    \ctxNotAnaType{\ctx}{\ECMV}{\TMV}
  }{
    \AACon{\ctx}{\ZCursor{\ECMV}}{\ZIfC{\ZCursor{\ECEHole}}{\ECInconType{\ECMV}}{\ECEHole}}{\TMV}{\SIfL}
  }{AAEConIfL2}
  ...
  \judgment{
    ...
    \AACon{\ctx}{\ZCursor{\ECMV}}{\ZIfC{\ZCursor{\ECEHole}}{\ECEHole}{\ECInconType{\ECMV}}}{\TMV}{\SIfR}
  }{AAEConIfR2}
\end{mathpar}
...
\begin{mathpar}
  ...
  \judgment{
    \AUTAction{\ZTMV}{\ZTMV'}{\AMV} \\
    \notMatchedArrow{\TMV}{\TMV_1}{\TMV_2} \\\\
    \ctxAnaFixedInto{\extendCtx{\ctx}{x}{\cursorErase{\ZTMV'}}}{\erase{\ECMV}}{\ECMV'}{\TUnknown}
  }{
  ...
  \judgment{
    \notMatchedArrow{\TMV}{\TMV_1}{\TMV_2} \\
    \AAAction{\extendCtx{\ctx}{x}{\TMV_3}}{\ZMV}{\ZMV'}{\TUnknown}{\AMV}
  }{
    \AAAction{\ctx}{\ZLamE{x}{\TMV_3}{\ZMV}}{\ZInconType{\ZLamE{x}{\TMV_3}{\ZMV'}}}{\TMV}{\AMV}
  }{AAEZipLamE2}

  \judgment{
    \matchedArrow{\TMV}{\TMV_1}{\TMV_2} \\
    \inconsistent{\TMV_1}{\TMV_3} \\\\
    \AAAction{\extendCtx{\ctx}{x}{\TMV_1}}{\ZMV}{\ZMV'}{\TMV_2}{\AMV}
  }{
    \AAAction{\ctx}{\ZLamE{x}{\TMV_3}{\ZMV}}{\ZInconType{\ZLamE{x}{\TMV_3}{\ZMV'}}}{\TMV}{\AMV}
  }{AAEZipLamE3}
\end{mathpar}
...
\begin{theorem}[name=Sensibility] \
  \begin{enumerate}
    \item If $\ctxSynType{\ctx}{\cursorErase{\ZMV}}{\TMV}$ and
      $\ASEAction{\ctx}{\ZMV}{\TMV}{\ZMV'}{\TMV'}{\AMV}$, then
      $\ctxSynType{\ctx}{\cursorErase{\ZMV'}}{\TMV'}$.

    \item If $\ctxAnaType{\ctx}{\cursorErase{\ZMV}}{\TMV}$ and
      $\AAEAction{\ctx}{\ZMV}{\ZMV'}{\TMV}{\AMV}$, then
...
\begin{theorem}[name=Movement Erasure Invariance] \
  \begin{enumerate}
    ...
    \item If $\ctxSynType{\ctx}{\cursorErase{\ZMV}}{\TMV}$ and
      $\ASEAction{\ctx}{\ZMV}{\TMV}{\ZMV'}{\TMV'}{\AMove{\MMV}}$, then $\cursorErase{\ZMV} =
      \cursorErase{\ZMV'}$ and $\equal{\TMV}{\TMV'}$.

    \item If $\ctxAnaType{\ctx}{\cursorErase{\ZMV}}{\TMV}$ and
      $\AAEAction{\ctx}{\ZMV}{\ZMV'}{\TMV}{\AMove{\MMV}}$, then $\cursorErase{\ZMV} =
      \cursorErase{\ZMV'}$.
  \end{enumerate}
\end{theorem}
...
\begin{theorem}[name=Reachability] \
  \begin{enumerate}
    ...
    \item If $\ctxSynType{\ctx}{\cursorErase{\ZMV}}{\TMV}$ and $\cursorErase{\ZMV} =
      \cursorErase{\ZMV'}$, then there exists $\AIMV$ such that $\movements{\AIMV}$ and
      $\ASEActionIter{\ctx}{\ZMV}{\TMV}{\ZMV'}{\TMV}{\AIMV}$.

    \item If $\ctxAnaType{\ctx}{\cursorErase{\ZMV}}{\TMV}$ and $\cursorErase{\ZMV} =
      \cursorErase{\ZMV'}$, then there exists $\AIMV$ such that $\movements{\AIMV}$ and
      $\AAEActionIter{\ctx}{\ZMV}{\ZMV'}{\TMV}{\AIMV}$.
  \end{enumerate}
\end{theorem}
...
\begin{lemma}[name=Reach Up] \
  \begin{enumerate}
    ...
    \item If $\ctxSynType{\ctx}{\cursorErase{\ZMV}}{\TMV}$ and $\cursorErase{\ZMV} = \ECMV$, then
      there exists $\AIMV$ such that $\movements{\AIMV}$ and
      $\ASEActionIter{\ctx}{\ZMV}{\TMV}{\ZTCursor{\ECMV}}{\TMV}{\AIMV}$.

    \item If $\ctxAnaType{\ctx}{\cursorErase{\ZMV}}{\TMV}$ and $\cursorErase{\ZMV} = \ECMV$, then
      there exists $\AIMV$ such that $\movements{\AIMV}$ and
