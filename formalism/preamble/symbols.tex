...
% construction
\newcommand{\ATConArrowL}[1]{\ensuremath{\ACCon{\ZTCursor{#1}}{\ZTArrowR{#1}{\ZTCursor{\TUnknown}}}{\STArrowL}}}
\newcommand{\ATConArrowR}[1]{\ensuremath{\ACCon{\ZTCursor{#1}}{\ZTArrowR{\ZTCursor{\TUnknown}}{#1}}{\STArrowR}}}
...
\newcommand{\AEMLetChildL}[3]{\ensuremath{\AEMChild{\ELet{#1}{#2}{#3}}{\ZLetL{#1}{\ZCursor{#2}}{#3}}{1}}}
\newcommand{\AEMLetChildR}[3]{\ensuremath{\AEMChild{\ELet{#1}{#2}{#3}}{\ZLetR{#1}{#2}{\ZCursor{#3}}}{2}}}
\newcommand{\AEMLetParentL}[3]{\ensuremath{\AEMParent{\ZLetL{#1}{\ZCursor{#2}}{#3}}{\ELet{#1}{#2}{#3}}}}
\newcommand{\AEMLetParentR}[3]{\ensuremath{\AEMParent{\ZLetR{#1}{#2}{\ZCursor{#3}}}{\ELet{#1}{#2}{#3}}}}
...
\newcommand{\AEConLetL}[2]{\ensuremath{\ACCon{\ZCursor{#2}}{\ZLetL{#1}{#2}{\ZCursor{\EEHole}}}{\SLetL{#1}}}}
\newcommand{\AEConLetR}[2]{\ensuremath{\ACCon{\ZCursor{#2}}{\ZLetR{#1}{\ZCursor{\EEHole}}{#2}}{\SLetR{#1}}}}
\newcommand{\AEConNum}[1]{\ensuremath{\ACCon{\ZCursor{\EEHole}}{\ZCursor{#1}}{\SLit{#1}}}}
