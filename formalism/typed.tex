...
\begin{mathparpagebreakable}
  ...
  \inferrule[ASEConFree]{
    ...
    \ASCon{\ctx}{\ZCCursor{\ECEHole}}{\TUnknown}{\ZCCursor{\ECFree{x}}}{\TUnknown}{\SVar{x}}
  }
...
\begin{mathparpagebreakable}
  ...
  \inferrule[AAEZipLetR]{
    \ctxSynTypeM{\ctx}{\ECMV}{\TMV_1} \\
    \AAAction{\extendCtx{\ctx}{x}{\TMV_1}}{\ZCMV}{\ZCMV'}{\TMV}{\AMV}
  }{
  ...
  \inferrule[AAEZipPairL1]{
    \matchedProd{\TMV}{\TMV_1}{\TMV_2} \\
    \AAAction{\ctx}{\ZCMV}{\ZCMV'}{\TMV_1}{\AMV}
  }{
    \AAAction{\ctx}{\ZCPairL{\ZCMV}{\ECMV}}{\ZCPairL{\ZCMV'}{\ECMV}}{\TMV}{\AMV}
  }

  \inferrule[AAEZipPairL2]{
    \AAAction{\ctx}{\ZCMV}{\ZCMV'}{\TUnknown}{\AMV}
  }{
    \AAAction{\ctx}{\ZCPairAnaNonMatchedProdL{\ZCMV}{\ECMV}}{\ZCPairAnaNonMatchedProdL{\ZCMV'}{\ECMV}}{\TMV}{\AMV}
  }

  \inferrule[AAEZipPairR1]{
    \matchedProd{\TMV}{\TMV_1}{\TMV_2} \\
    \AAAction{\ctx}{\ZCMV}{\ZCMV'}{\TMV_2}{\AMV}
  }{
    \AAAction{\ctx}{\ZCPairR{\ECMV}{\ZCMV}}{\ZCPairR{\ECMV}{\ZCMV'}}{\TMV}{\AMV}
  }

  \inferrule[AAEZipPairR2]{
    \AAAction{\ctx}{\ZCMV}{\ZCMV'}{\TUnknown}{\AMV}
  }{
    \AAAction{\ctx}{\ZCPairAnaNonMatchedProdR{\ECMV}{\ZCMV}}{\ZCPairAnaNonMatchedProdR{\ECMV}{\ZCMV'}}{\TMV}{\AMV}
  }
\end{mathparpagebreakable}
